...
function MoveFileToPath()
  local oldfile = vim.fn.expand('%:p')
  local newfile = vim.fn.input('Move to: ', '', 'file')
  os.execute('mv ' .. vim.fn.shellescape(oldfile) .. ' ' .. vim.fn.shellescape(newfile))
...
_G.MoveFileToPath = MoveFileToPath
